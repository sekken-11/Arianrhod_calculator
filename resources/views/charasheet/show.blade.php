                        ...
                        <div class="w-full xl:w-1/2 xl:pe-2 mb-3">
                            <div class="bg-white shadow-md rounded">
                                <table class="min-w-max w-full table-auto">
                                    ...
                                    <tbody class="text-gray-600 text-xs font-light">
                                        <tr class="border-b border-gray-200">
                                            <td class="py-2 text-center whitespace-nowrap">{{ $character->tribe->name }}
                                            </td>
                                            <td class="py-2 text-center whitespace-nowrap">{{
                                                $character->main_class->name }}</td>
                                            <td class="py-2 text-center whitespace-nowrap">{{
                                                $character->support_class->name }}</td>
                                            <td class="py-2 text-center whitespace-nowrap">{{ $character->honor_class }}
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                <table class="min-w-max w-full table-auto">
                                    ...
                                    <tbody class="text-gray-600 text-xs font-light">
                                        <tr class="border-b border-gray-200">
                                            ...
                                            <td class="py-2 text-center whitespace-nowrap">{{ $character->exp_point }}
                                            </td>
                                            <td class="py-2 text-center whitespace-nowrap">
                                ...
                                <table class="min-w-max w-full table-auto">
                                    <thead>
                                        <tr class="bg-gray-200 text-gray-600 text-xs leading-normal">
                                            <th class="mini_item py-1 text-center">武器<br>重量制限</th>
                                            <th class="mini_item py-1 text-center">防具<br>重量制限</th>
                                            <th class="mini_item py-1 text-center">携帯品<br>重量制限</th>
                                            <th class="mini_item py-1 text-center">初期<br>メインクラス</th>
                                            <th class="mini_item py-1 text-center">初期<br>サポートクラス</th>
                                        </tr>
                                    </thead>
                                    <tbody class="text-gray-600 text-xs font-light">
                                        <tr class="border-b border-gray-200">
                                            <td class="py-2 text-center whitespace-nowrap">
                                                {{ $character->weapon_weight_correction +
                                                $character->tribe->weight_limit }}
                                            </td>
                                            <td class="py-2 text-center whitespace-nowrap">
                                                {{ $character->armor_weight_correction + $character->tribe->weight_limit
                                                }}
                                            </td>
                                            <td class="py-2 text-center whitespace-nowrap">
                                                {{ $character->item_weight_correction + $character->tribe->weight_limit
                                                }}
                                            </td>
                                            <td class="py-2 text-center whitespace-nowrap">{{
                                                $character->initial_main_class }}</td>
                                            <td class="py-2 text-center whitespace-nowrap">{{
                                                $character->initial_support_class }}</td>
                                        </tr>
                                    </tbody>
                                </table>
                                <table class="min-w-max w-full table-auto">
                        ...
                        <div class="w-full xl:w-1/2 xl:ps-2 mb-3">
                            <div class="bg-white shadow-md rounded">
                                <table class="min-w-max w-full table-auto">
                                    ...
                                    <tbody class="text-gray-600 text-xs font-light">
                                        <tr class="border-b border-gray-200">
                                            ...
                                            <td class="py-2 text-center whitespace-nowrap">{{ $character->height }}cm
                                            </td>
                                            <td class="py-2 text-center whitespace-nowrap">{{ $character->hair_color }}
                                            </td>
                                            <td class="py-2 text-center whitespace-nowrap">{{ $character->eye_color }}
                                            </td>
                                            <td class="py-2 text-center whitespace-nowrap">{{ $character->skin_color }}
                                            </td>
                                            <td class="py-2 text-center whitespace-nowrap">{{ $character->hometown }}
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                    ...
                                    <tbody class="text-gray-600 text-xs font-light">
                                        ...
                                        <tr class="border-b border-gray-200">
                                            ...
                                            <td class="py-2 px-3 vertical-align-top">
                                                <span class="break-first">{{ $character->{$lifepass . '_remarks'}
                                                    }}</span>
                                            </td>
                                            @else
                                ...
                                <table class="min-w-max w-full table-fixed">
                                    <thead>
                                        <tr class="bg-gray-200 text-gray-600 text-xs leading-normal">
                                            <th class="py-1 text-center">キャラクターについて</th>
                                        </tr>
                                    </thead>
                                    <tbody class="text-gray-600 text-xs font-light">
                                        <tr class="border-b border-gray-200">
                                            @if(!empty($character->remarks))
                                            <td class="py-2 px-3 vertical-align-top">
                                                <span class="break-first">{{ $character->remarks }}</span>
                                            </td>
                                            @else
                                            <td class="py-2 px-3 text-center">-</td>
                                            @endif
                                ...
                                <table class="min-w-max w-full table-auto">
                                    ...
                                    <thead>
                                        <tr class="bg-gray-200 text-gray-600 text-xs leading-normal">
                                            ...
                                            <th class="mini_status_title skill_{{ $skill['en'] }} py-1 text-center">{{
                                                $skill['jp'] }}</th>
                                            @endforeach
                                        </tr>
                                    </thead>
