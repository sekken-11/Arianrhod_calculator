            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="container small">
                        ...
                        <form action="{{ route('admin.main_class.update', ['main_class' => $main_class->id]) }}" method="POST">
                        @csrf
                        @method('PUT')
                            <fieldset>
                                        ...
                                        <div class="w-full sm:w-1/2 px-2 mb-4">
                                            <div class="my-2">
                                                ...
                                                <input type="text" class="form-control block w-full bg-gray-200 border border-gray-200 rounded focus:outline-none focus:bg-white"
                                                 name="name" id="name" value="{{ $main_class->name }}">
                                            </div>
                                        </div>
                                        <div class="w-full sm:w-1/2 px-2 mb-4">
                                            <div class="my-2">
                                                ...
                                                <input type="text" class="form-control block w-full bg-gray-200 border border-gray-200 rounded focus:outline-none focus:bg-white"
                                                 name="strength_correction" id="strength_correction" value="{{ $main_class->strength_correction }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="flex flex-wrap">
                                        <div class="w-full sm:w-1/2 px-2 mb-4">
                                            <div class="my-2">
                                                ...
                                                <input type="text" class="form-control block w-full bg-gray-200 border border-gray-200 rounded focus:outline-none focus:bg-white"
                                                 name="dexterity_correction" id="dexterity_correction" value="{{ $main_class->dexterity_correction }}">
                                            </div>
                                        </div>
                                        <div class="w-full sm:w-1/2 px-2 mb-4">
                                            <div class="my-2">
                                                ...
                                                <input type="text" class="form-control block w-full bg-gray-200 border border-gray-200 rounded focus:outline-none focus:bg-white"
                                                 name="agility_correction" id="agility_correction" value="{{ $main_class->agility_correction }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="flex flex-wrap">
                                        <div class="w-full sm:w-1/2 px-2 mb-4">
                                            <div class="my-2">
                                                ...
                                                <input type="text" class="form-control block w-full bg-gray-200 border border-gray-200 rounded focus:outline-none focus:bg-white"
                                                 name="intelligence_correction" id="intelligence_correction" value="{{ $main_class->intelligence_correction }}">
                                            </div>
                                        </div>
                                        <div class="w-full sm:w-1/2 px-2 mb-4">
                                            <div class="my-2">
                                                ...
                                                <input type="text" class="form-control block w-full bg-gray-200 border border-gray-200 rounded focus:outline-none focus:bg-white"
                                                 name="sense_correction" id="sense_correction" value="{{ $main_class->sense_correction }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="flex flex-wrap">
                                        <div class="w-full sm:w-1/2 px-2 mb-4">
                                            <div class="my-2">
                                                ...
                                                <input type="text" class="form-control block w-full bg-gray-200 border border-gray-200 rounded focus:outline-none focus:bg-white"
                                                 name="mental_correction" id="mental_correction" value="{{ $main_class->mental_correction }}">
                                            </div>
                                        </div>
                                        <div class="w-full sm:w-1/2 px-2 mb-4">
                                            <div class="my-2">
                                                ...
                                                <input type="text" class="form-control block w-full bg-gray-200 border border-gray-200 rounded focus:outline-none focus:bg-white"
                                                 name="luck_correction" id="luck_correction" value="{{ $main_class->luck_correction }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="flex flex-wrap">
                                        <div class="w-full sm:w-1/2 px-2 mb-4">
                                            <div class="my-2">
                                                ...
                                                <input type="text" class="form-control block w-full bg-gray-200 border border-gray-200 rounded focus:outline-none focus:bg-white"
                                                 name="hp_correction" id="hp_correction" value="{{ $main_class->hp_correction }}">
                                            </div>
                                        </div>
                                        <div class="w-full sm:w-1/2 px-2 mb-4">
                                            <div class="my-2">
                                                ...
                                                <input type="text" class="form-control block w-full bg-gray-200 border border-gray-200 rounded focus:outline-none focus:bg-white"
                                                 name="mp_correction" id="mp_correction" value="{{ $main_class->mp_correction }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="flex flex-wrap">
